...
public enum Code {
    ...
    EVENT_ALREADY_PUBLISHED("event_already_published", "Event is already published in a building"),
    EVENT_SESSION_REQUIRED("event_session_required", "Event session is missing or has expired"),
    EVENT_MEMBER_NAME_TAKEN("event_member_name_taken", "This name is already taken in the event"),
    EVENT_RETURN_CODE_INVALID("event_return_code_invalid", "Return code is not valid"),
    EVENT_MEMBER_LOCKED("event_member_locked", "Too many attempts, try again later"),
    ...
    INVALID_AUTHORIZATION_TOKEN("invalid_authorization_token", "Authorization token is not valid"),
