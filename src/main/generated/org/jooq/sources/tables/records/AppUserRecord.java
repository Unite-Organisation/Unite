...
public class AppUserRecord extends UpdatableRecordImpl<AppUserRecord> {
    ...
    /**
     * Setter for <code>public.app_user.building_id</code>.
     */
    ...
    /**
     * Getter for <code>public.app_user.building_id</code>.
     */
     ...
     */
    public AppUserRecord(UUID id, String firstName, String lastName, String email, String username, String password, UUID userRole, String status, LocalDateTime createdAt, UUID buildingId) {
        super(AppUser.APP_USER);
