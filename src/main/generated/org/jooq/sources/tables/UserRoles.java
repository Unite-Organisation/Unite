...
public class UserRoles extends TableImpl<UserRolesRecord> {
    ...
    /**
     * The column <code>public.user_roles.user_role</code>.
     */
    public final TableField<UserRolesRecord, String> USER_ROLE = createField(DSL.name("user_role"), SQLDataType.VARCHAR(15).nullable(false), this, "");
    ...
    public UsersPath users() {
        if (_users == null)
            _users = new UsersPath(this, null, Keys.USERS__USERS_USER_ROLE_FKEY.getInverseKey());
