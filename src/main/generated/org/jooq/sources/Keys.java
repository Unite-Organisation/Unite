...
public class Keys {
    ...
    public static final ForeignKey<EventRecord, BuildingRecord> EVENT__EVENT_BUILDING_ID_FKEY = Internal.createForeignKey(Event.EVENT, DSL.name("event_building_id_fkey"), new TableField[] { Event.EVENT.BUILDING_ID }, Keys.BUILDING_PKEY, new TableField[] { Building.BUILDING.ID }, true);
