...
public class Keys {
    ...
    public static final UniqueKey<EventRecord> EVENT_PUBLIC_SLUG_KEY = Internal.createUniqueKey(Event.EVENT, DSL.name("event_public_slug_key"), new TableField[] { Event.EVENT.PUBLIC_SLUG }, true);
    public static final UniqueKey<EventMemberRecord> EVENT_MEMBER_PKEY = Internal.createUniqueKey(EventMember.EVENT_MEMBER, DSL.name("event_member_pkey"), new TableField[] { EventMember.EVENT_MEMBER.ID }, true);
    public static final UniqueKey<EventMemberMetadataRecord> EVENT_MEMBER_METADATA_PKEY = Internal.createUniqueKey(EventMemberMetadata.EVENT_MEMBER_METADATA, DSL.name("event_member_metadata_pkey"), new TableField[] { EventMemberMetadata.EVENT_MEMBER_METADATA.ID }, true);
    public static final UniqueKey<EventMemberSessionRecord> EVENT_MEMBER_SESSION_PKEY = Internal.createUniqueKey(EventMemberSession.EVENT_MEMBER_SESSION, DSL.name("event_member_session_pkey"), new TableField[] { EventMemberSession.EVENT_MEMBER_SESSION.ID }, true);
    public static final UniqueKey<EventMemberSessionRecord> EVENT_MEMBER_SESSION_TOKEN_HASH_KEY = Internal.createUniqueKey(EventMemberSession.EVENT_MEMBER_SESSION, DSL.name("event_member_session_token_hash_key"), new TableField[] { EventMemberSession.EVENT_MEMBER_SESSION.TOKEN_HASH }, true);
    ...
    public static final UniqueKey<PostRecord> POST_EVENT_ID_KEY = Internal.createUniqueKey(Post.POST, DSL.name("post_event_id_key"), new TableField[] { Post.POST.EVENT_ID }, true);
    ...
    public static final ForeignKey<EventMemberRecord, EventRecord> EVENT_MEMBER__EVENT_MEMBER_EVENT_ID_FKEY = Internal.createForeignKey(EventMember.EVENT_MEMBER, DSL.name("event_member_event_id_fkey"), new TableField[] { EventMember.EVENT_MEMBER.EVENT_ID }, Keys.EVENT_PKEY, new TableField[] { Event.EVENT.ID }, true);
    public static final ForeignKey<EventMemberRecord, AppUserRecord> EVENT_MEMBER__EVENT_MEMBER_USER_ID_FKEY = Internal.createForeignKey(EventMember.EVENT_MEMBER, DSL.name("event_member_user_id_fkey"), new TableField[] { EventMember.EVENT_MEMBER.USER_ID }, Keys.APP_USER_PKEY, new TableField[] { AppUser.APP_USER.ID }, true);
    public static final ForeignKey<EventMemberMetadataRecord, EventMemberRecord> EVENT_MEMBER_METADATA__EVENT_MEMBER_METADATA_MEMBER_ID_FKEY = Internal.createForeignKey(EventMemberMetadata.EVENT_MEMBER_METADATA, DSL.name("event_member_metadata_member_id_fkey"), new TableField[] { EventMemberMetadata.EVENT_MEMBER_METADATA.MEMBER_ID }, Keys.EVENT_MEMBER_PKEY, new TableField[] { EventMember.EVENT_MEMBER.ID }, true);
    public static final ForeignKey<EventMemberSessionRecord, EventMemberRecord> EVENT_MEMBER_SESSION__EVENT_MEMBER_SESSION_MEMBER_ID_FKEY = Internal.createForeignKey(EventMemberSession.EVENT_MEMBER_SESSION, DSL.name("event_member_session_member_id_fkey"), new TableField[] { EventMemberSession.EVENT_MEMBER_SESSION.MEMBER_ID }, Keys.EVENT_MEMBER_PKEY, new TableField[] { EventMember.EVENT_MEMBER.ID }, true);
    ...
    public static final ForeignKey<PostRecord, EventRecord> POST__POST_EVENT_ID_FKEY = Internal.createForeignKey(Post.POST, DSL.name("post_event_id_fkey"), new TableField[] { Post.POST.EVENT_ID }, Keys.EVENT_PKEY, new TableField[] { Event.EVENT.ID }, true);
