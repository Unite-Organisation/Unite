...
public class Keys {
    ...
    public static final ForeignKey<PollResultRecord, PollOptionsRecord> POLL_RESULT__POLL_RESULT_CHOSEN_OPTION_FKEY = Internal.createForeignKey(PollResult.POLL_RESULT, DSL.name("poll_result_chosen_option_fkey"), new TableField[] { PollResult.POLL_RESULT.CHOSEN_OPTION }, Keys.POLL_OPTIONS_PKEY, new TableField[] { PollOptions.POLL_OPTIONS.ID }, true);
