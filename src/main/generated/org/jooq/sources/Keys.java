...
public class Keys {
    ...
    public static final ForeignKey<OfferingRecord, IssueRecord> OFFERING__OFFERINGS_AREA_ID_FKEY = Internal.createForeignKey(Offering.OFFERING, DSL.name("offerings_area_id_fkey"), new TableField[] { Offering.OFFERING.AREA_ID }, Keys.ISSUE_PKEY, new TableField[] { Issue.ISSUE.ID }, true);
